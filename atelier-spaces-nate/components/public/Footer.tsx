          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2 text-gray-400 text-sm">
                ...
                <a href="tel:+256770669746" className="hover:text-white transition-colors">
                  +256-770669746
                </a>
              </div>
              <div className="flex items-start gap-2 text-gray-400 text-sm">
                ...
                <div className="flex flex-col">
                  <a href="mailto:contact@atelierspacenate.com" className="hover:text-white transition-colors">
                    contact@atelierspacenate.com
                  </a>
                  <a href="mailto:atelierspacesnate@gmail.com" className="hover:text-white transition-colors">
            ...
            <div className="flex gap-4 pt-3">
              <a href="https://instagram.com/natespaces.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors" aria-label="Instagram">
                <FiInstagram size={18} />
              </a>
              <a href="https://twitter.com/natespaces.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors" aria-label="Twitter">
                <FiTwitter size={18} />
              </a>
              <a href="https://tiktok.com/@natespaces.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors" aria-label="TikTok">
