    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage categories for your portfolio works</p>
        </div>
        <Link
      ...
      {workCategories && workCategories.length > 0 ? (
        ...
        <div className="bg-gray-50 rounded-lg p-12 text-center">
          <p className="text-gray-600 mb-4">No work categories yet. Create your first category.</p>
          <Link
            href="/admin/work-categories/new"
