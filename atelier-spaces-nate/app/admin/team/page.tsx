        ...
        <div className="bg-red-50 border-l-4 border-red-500 rounded-lg shadow-sm p-6">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-red-800 mb-2">Failed to Load Team Members</h3>
              <p className="text-sm text-red-700 mb-4">{error}</p>
              
              <div className="bg-white rounded p-4 mb-4">
                <h4 className="font-semibold text-red-900 mb-2">Possible causes:</h4>
                <ul className="list-disc list-inside text-sm text-red-800 space-y-1">
                  <li>The <code className="bg-red-100 px-1 rounded">team_members</code> table doesn't exist in Supabase</li>
